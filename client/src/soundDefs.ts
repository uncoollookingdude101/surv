...
const Sounds: Record<string, Record<string, SoundDef>> = {
    players: {
        ...
        m2010_01: {
            path: "audio/guns/m2010_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        m2010_cycle_01: {
            path: "audio/guns/m2010_cycle_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        m2010_reload_01: {
            path: "audio/guns/m2010_reload_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        pkm_01: {
            path: "audio/guns/pkm_01.mp3",
            volume: 7,
            maxInstances: 5,
        },
        lasr_gun_reload_01: {
        ...
        m96_01: {
            path: "audio/guns/m96_01.mp3",
            volume: 5,
            maxInstances: 10,
        },
        m96_reload_01: {
            path: "audio/guns/m96_reload_01.mp3",
            volume: 1,
        },
        m96_cycle_01: {
            path: "audio/guns/m96_cycle_01.mp3",
            volume: 5,
        },
        m72_01: {
            path: "audio/guns/m72_01.mp3",
            volume: 3,
            maxInstances: 10,
        },
        m72_reload_01: {
            path: "audio/guns/m72_reload_01.mp3",
            volume: 1,
        },
        empty_fire_01: {
