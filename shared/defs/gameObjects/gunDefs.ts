...
export const BaseDefs: Record<string, GunDef> = {
    ...
    m2010: {
        ...
        shotSpread: 0.5,
        bulletCount: 1,
        bulletType: "bullet_m2010",
        headshotMult: 1.5,
        armorPiercing: true,
        speed: { equip: 0, attack: 3 },
        lootImg: {
            sprite: "loot-weapon-m2010.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    m82: {
        ...
        shotSpread: 1.5,
        bulletCount: 1,
        bulletType: "bullet_m82",
        headshotMult: 1.2,
        stonePiercing: true,
        armorPiercing: true,
        speed: { equip: -3, attack: -5 },
        lootImg: {
            sprite: "loot-weapon-m82.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
        ...
        particle: { shellScale: 2.2, shellOffset: 0.8 },
        sound: {
            shoot: "m82_01",
            reload: "m82_reload_01",
            cycle: "m82_cycle_01",
            pull: "sv_pull_01",
            pickup: "gun_pickup_01",
            empty: "empty_fire_02",
    ...
    p90: {
        ...
        particle: { shellScale: 1.1, shellOffset: 0.5 },
        sound: {
            shoot: "p90_01",
            reload: "p90_reload_01",
            pickup: "gun_pickup_01",
            empty: "empty_fire_01",
            deploy: "vector_switch_01",
        },
    ...
    dp12: {
        ...
        bulletCount: 6,
        jitter: 0.75,
        bulletType: "bullet_dragonbreath",
        headshotMult: 1.2,
        speed: { equip: -1, attack: -2 },
        lootImg: {
            sprite: "loot-weapon-dp12.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
        ...
        worldImg: {
            sprite: "gun-dp12-01.img",
            scale: { x: 0.5, y: 0.5 },
            tint: 0xffffff,
            leftHandOffset: { x: 0, y: 0 },
            recoil: 1.8,
        },
        particle: { shellScale: 1.1, shellOffset: 0.4 },
        sound: {
            shoot: "mp220_01",
            reload: "m870_reload_01",
            pickup: "gun_pickup_01",
    ...
    m96: {
        ...
        shotSpread: 1,
        bulletCount: 1,
        bulletType: "bullet_m96",
        headshotMult: 1.25,
        armorPiercing: true,
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-m96.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    skorpion: {
        ...
        shotSpread: 3,
        bulletCount: 1,
        bulletType: "bullet_skorpion",
        headshotMult: 2,
        speed: { equip: 1, attack: 1 },
        lootImg: {
            sprite: "loot-weapon-skorpion.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    skorpion_dual: {
        ...
        speed: { equip: 1, attack: 1 },
        lootImg: {
            sprite: "loot-weapon-skorpion-dual.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
