...
const mapDef = {
    ...
    lootTable: {
        tier_guns: [{ name: "flare_gun2", count: 1, weight: 10 }],
        tier_airdrop_uncommon: [{ name: "flare_gun2", count: 1, weight: 0.5 }],
        tier_airdrop_rare: [{ name: "flare_gun2", count: 1, weight: 6 }],
        tier_ammo: [{ name: "flare", count: 5, weight: 3 }],
        tier_ammo_crate: [{ name: "flare", count: 5, weight: 1 }],
        tier_airdrop_ammo: [{ name: "flare", count: 10, weight: 3 }],
        ...
        tier_hatchet: [{ name: "flare_gun2", count: 1, weight: 0.4 }],
        tier_throwables: [{ name: "smoke", count: 1, weight: 1 }],
        tier_airdrop_throwables: [{ name: "smoke", count: 1, weight: 1 }],
    },
    mapGen: {
        map: {
            baseWidth: 300,
