...
export const MapObjectDefs: Record<string, MapObjectDef> = {
    ...
    crate_01a: createCrate({ loot: [tierLoot("tier_custom", 1, 1)] }),
    ...
    crate_13ct1: createCrate({
        ...
        loot: [
            ...
            autoLoot("p30l_dual", 1),
            autoLoot("ots38_dual", 1),
            autoLoot("colt45_dual", 1),
            autoLoot("m1911_dual", 1),
            autoLoot("m1a1", 1),
            autoLoot("deagle_dual", 1),
            autoLoot("potato_cannon", 1),
            autoLoot("potato_smg", 1),
            autoLoot("bugle", 1),
            autoLoot("pkm", 1),
            autoLoot("m134", 1),
            autoLoot("m79", 1),
            autoLoot("lasr_gun_dual", 1),
            autoLoot("coconut_smg", 1),
            autoLoot("m2010", 1),
            autoLoot("mirv", 15),
            autoLoot("strobe", 15),
    ...
    crate_13ct2: createCrate({
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(3.5, 3.5)),
        scale: { destroy: 0.75 },
        health: 200,
        loot: [
            autoLoot("bandage", 50),
            autoLoot("healthkit", 20),
            autoLoot("bb", 30),
            autoLoot("mirv", 30),
            autoLoot("strobe", 30),
        ],
    ...
    airdrop_crate_01a: createAirdrop({
        button: {
            useImg: "map-airdrop-02.img",
            useParticle: "airdropCrate01",
            sound: { on: "airdrop_open_01", off: "" },
    ...
    airdrop_crate_04ct1: createAirdrop({
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(4, 4)),
        button: {
            useImg: "map-airdrop-04.img",
            useParticle: "airdropCrate03",
        ...
        destroyType: "crate_13ct1",
        explodeParticle: "airdropCrate04",
    } as unknown as Partial<ObstacleDef>),
    airdrop_crate_04ct2: createAirdrop({
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(4, 4)),
        button: {
            useImg: "map-airdrop-04.img",
            useParticle: "airdropCrate03",
    ...
    greenhouse_01as: createGreenhouse({
        mapObjects: [
            {
                type: "glass_wall_10",
                pos: v2.create(-7, 19.5),
    ...
    bunker_chrys_sublevel_01as: {
        ...
        mapObjects: [
            ...
            {
                type: "bunker_chrys_compartment_03as",
                pos: v2.create(43.5, 43),
                scale: 1,
                ori: 0,
            },
    ...
    bunker_structure_08as: createBunkerChrys({
        bunkerType: "bunker_chrys_sublevel_01as",
    }),
    ...
    bunker_crossing_compartment_01a: {
        type: "building",
        map: { display: false, color: 0x665a4e, scale: 1 },
        terrain: { grass: true, beach: false },
        zIdx: 2,
